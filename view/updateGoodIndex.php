...
<?php if ($_SESSION['is_admin'] == 1) : ?>
    ...
    <form method="post" action="?p=updateGood&a=updateDataOfGood">
        ...
        <input name="nameForUpdate" id="nameForUpdate" value="<?= $good['name'] ?>">
        <input name="priceForUpdate" id="priceForUpdate" value="<?= $good['price'] ?>"><br><br>
        <input name="infoForUpdate" id="infoForUpdate" value="<?= $good['info'] ?>">
